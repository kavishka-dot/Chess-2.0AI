...
def main():
    ...
    playerOne = False # if a human is playing white, it is true, it an AI is playing, it is false
    playerTwo = False
...
def highlightCheckSquare(screen, gs):
    ...
    if gs.whiteToMove:
        ...
        if len(gs.getValidMoves())==0:
            ...
            screen.blit(s, (gs.whiteKingPosition[1]*SQ_SIZE, gs.whiteKingPosition[0]*SQ_SIZE))
...
def drawBoard(screen):
    ...
    colors = [p.Color("white"), p.Color("slategray3")]
...
def drawText(screen, text):
    font = p.font.SysFont("DejaVuSans-Bold", 32, True, False)
